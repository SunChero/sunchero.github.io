...
![Example](./dtp-main-p2.png)
![Example](./customizable.gif)

### Customizable running indicators

| Metro                          | Ciliora/Dashes                          |
| ------------------------------ | --------------------------------------- |
| ![Example](./metro.png)   | ![Example](./ciliora-dashes.png)   |
| ![Example](./ciliora.png) | ![Example](./squares-segments.png) |
| ![Example](./dashes.png)  | ![Example](./dots-solid.png)       |

### Live previews on hover

![Example](./previews.gif)
