...
![Initial installation](./initial-installation-1.png)
![Initial installation](./initial-installation-2.png)
![Initial installation](./initial-installation-3.png)
![Initial installation](./initial-installation-4.png)
![Initial installation](./initial-installation-5.png)
![Initial installation](./initial-installation-6.png)
...
![Edit resolution 1](./edit-resolution-1.png)

```plain
sudo diskutil mount <EFI-PARTITION>
```

![Edit resolution 2](./edit-resolution-2.png)
