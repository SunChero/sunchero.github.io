...
![Menu Bar Layout](./menu-bar-layout.png)

### Customize the menu bar's appearance

![Menu Bar Appearance](./menu-bar-appearance.png)

### Menu bar item search

![Menu Bar Item Search](./menu-bar-item-search.png)

### Custom menu bar item spacing

![Menu Bar Item Spacing](./menu-bar-item-spacing.png)
